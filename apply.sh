...
safe_link "${SCRIPT_DIR}/app-launcher.el" \
          "$HOME/.emacs.d/packages/app-launcher.el"
safe_link "${SCRIPT_DIR}/my-simple-theme-base.el" \
          "$HOME/.emacs.d/packages/my-simple-theme-base.el"
safe_link "${SCRIPT_DIR}/my-charcoal-light-theme.el" \
          "$HOME/.emacs.d/my-charcoal-light-theme.el"
safe_link "${SCRIPT_DIR}/my-theme-base.el" \
          "$HOME/.emacs.d/packages/my-theme-base.el"
...
safe_link "${SCRIPT_DIR}/snw-mode.el" \
          "$HOME/.emacs.d/packages/snw-mode.el"
