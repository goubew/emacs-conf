...
(autothemer-deftheme
 ...
 (
  ;; basics
  (default (:background bg0 :foreground fg))

  (cursor              (:background ever_fg))
  ...
  (trailing-whitespace (:background red :foreground bg0))
  ...
  ;;; line numbers
  (line-number              (:background bg1))
  (line-number-current-line (:background bg1 :bold 't))
  ...
  (aw-background-face              (:foreground grey0))
  (aw-minibuffer-leading-char-face (:inherit 'aw-leading-char-face))
  (aw-leading-char-face            (:background red :foreground bg0))

  ;; avy
  (avy-background-face (:foreground grey2))
  (avy-lead-face       (:background red :foreground bg0))
  (avy-lead-face-0     (:background green :foreground bg0))
  (avy-lead-face-1     (:background yellow :foreground bg0))
  (avy-lead-face-2     (:background cyan :foreground bg0))

  ;; circe
  (circe-fool-face               (:foreground grey2))
  ...
  (circe-prompt-face             (:weight 'bold :foreground cyan :background bg1))
